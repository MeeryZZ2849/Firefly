...
export const site = {
  name: "Twilight Blog",
  desc: "言葉は人を奮い立たせ、考えは刺激を与えるが、夢に本当に近づけてくれるのは行動だけだ",
  url: "https://blog.twilightnya.top/",
  avatar: "https://blog.twilightnya.top/assets/images/logo.jpg",
  email: "MeeryZZ2849@duck.com",
};
