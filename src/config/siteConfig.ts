...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "记录日常，分享有趣的内容",

	// 站点 URL
	site_url: "https://blog.twilightnya.top",

	// 站点描述
	description:
		"言葉は人を奮い立たせ、考えは刺激を与えるが、夢に本当に近づけてくれるのは行動だけだ",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "/assets/images/twilight.jpg",
			alt: "🍀",
		},
		// 导航栏标题
		title: "TwiFork Blog",
	...
	analytics: {
		...
		umamiAnalytics: {
			// Umami Website ID
			websiteId: "79eca460-ec3c-4c83-afcf-7a87e0c2cfcf",
			// Umami JS地址，支持使用自建
			scriptUrl: "https://umami.twilightnya.top/script.js",
		},
		// 51la 统计配置
		la51Analytics: {
			// 51la 统计 ID
